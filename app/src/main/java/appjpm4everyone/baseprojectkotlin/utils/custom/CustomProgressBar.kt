package appjpm4everyone.baseprojectkotlin.utils.custom
...
class CustomProgressBar {
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        setColorFilter(
            ...
            ResourcesCompat.getColor(context.resources, R.color.cyanBlue, null)
        ) //Progress Bar Color
        view.cp_title.setTextColor(Color.WHITE) //Text Color

        dialog = Dialog(context, R.style.CustomProgressBarTheme)
        dialog.setContentView(view)
        //disable the backPressed when the view is showing
